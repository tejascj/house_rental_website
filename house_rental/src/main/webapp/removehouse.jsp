...
if(request.getParameter("submit")!=null) //check register button click event not null
{
	...
	try {
		...
		st.executeUpdate("delete from houses where id='"+id+"'");
		request.setAttribute("successMsg","House Details Deleted");	
		...
		<div class="forms">
			<div class="form-content">
				<div class="login-form">
					<div class="title">Delete House</div>
					<form method="post">
					<input type="hidden" name="id" value="<%out.println(id);%>" disabled>
						<div class="input-boxes">
							<div class="input-box">
							<label>Address</label>
								<input type="text" name="address" value="<%=rs.getString(3) %>" disabled>
							</div>
							<div class="input-box">
